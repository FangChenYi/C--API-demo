...
public class NZWalksDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var difficulties = new List<Difficulty>()
        {
            new Difficulty()
            {
                Id = Guid.Parse("a2ab05e4-7a6d-4f7c-8eac-5e4a98723a1b"),
                Name = "Easy"
            },
            new Difficulty()
            {
                Id = Guid.Parse("8f31d96b-8103-4789-ae9c-72b20f8dc6a5"),
                Name = "Medium"
            },
            new Difficulty()
            {
                Id = Guid.Parse("d92f6f1c-2a84-4be0-9a5b-689e4fe5c6d7"),
                Name = "Hard"
            },
        };
